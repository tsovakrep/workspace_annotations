package by.htp.itacademy.processor.builder;
...
@SupportedAnnotationTypes(BuilderProcessor.ANNOTATION_TYPE)
@SupportedSourceVersion(SourceVersion.RELEASE_8)
@AutoService(Processor.class)
public class BuilderProcessor extends AbstractProcessor {

	public static final String ANNOTATION_TYPE = "by.htp.itacademy.annotation.BuilderProperty";
	
	private final static DevLog log = new DevLog("C:/1/logBuilderProcessor.txt");
